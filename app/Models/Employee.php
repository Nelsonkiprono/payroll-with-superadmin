...
class Employee extends Model
{
    ...
    {
        //$employee = DB::table('x_employee')->where('in_employment', '=', 'Y')->where('confirmed','Y')->where('organization_id', Auth::user()->organization_id)->get();
        $employee = Employee::where('in_employment', '=', 'Y')->where('organization_id', Auth::user()->organization_id)->get();
        return $employee;
    }
    public function getProbabtionEmployee()
    {
        //$employee = DB::table('x_employee')->where('in_employment', '=', 'Y')->where('confirmed','N')->where('organization_id', Auth::user()->organization_id)->get();
        $employee = Employee::where('in_employment', '=', 'Y')->where('organization_id', Auth::user()->organization_id)->get();
        return $employee;
    }
    ...
    {
        return $this->belongsTo(EType::class,'type_id');
    }
}
