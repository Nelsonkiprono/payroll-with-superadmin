...
Route::get('api/dropdown/{name}', function () {
    $id = request()->name;
...
Route::post('nssf/update/.$prate->id', [NssfController::class, 'update']);
...
Route::post('probation/store',[ProbationController::class,'store']);
Route::post('probation/update',[ProbationController::class,'update']);
Route::get('probation/getProbation',[ProbationController::class,'getProbation']);
/*
 * Timesheet
 */
...
// Super Admin routes added by Dominick on 11/09/2023
