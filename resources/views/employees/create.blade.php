                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body" style="border: 1px solid blue">
                                                ...
                                                <div id="page4" class="row" style="display: none">
                                                    ...
                                                    <div id="probation" class="col-sm-3">

                                                    </div>
                                                    <div id="contract" class="col-sm-3">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="form-group-lg col-lg-4">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input id="ch" type="checkbox" checked name="confirmed">
                                                                Confirmed
                                                            </label>
                                                        </div>
                                                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#type_id").on("change", function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        else if(response[0].employee_type_name  ==='Probation')
                        {
                            $.ajax({
                                type: "GET",
                                url: "http://127.0.0.1/payroll/public/probation/getProbation",
                                data: "_token<?php echo csrf_token()?>",
                                success: function (dataRe) {
                                    if (dataRe.success ===1)
                                    {
                                        var output = '<label>Probation Period</label><select name="probationPeriod" class="form-control">'
                                        for (var x=0;x<dataRe.probation.length;x++)
                                        {
                                            output += '<option value="'+dataRe.probation[x]['id']+'">'+dataRe.probation[x]['period']+'</option>'
                                        }
                                        $("#probation").show();
                                        $('#contract').hide();
                                        output+='</select>';
                                        document.getElementById('probation').innerHTML = output
                                    }
                                }
                            })
                        }
            ...
            $('#bank_id').change(function () {
                var name = document.getElementById('bank_id').value;
                $.ajax({
                    url: "http://127.0.0.1/payroll/public/api/dropdown/" + name,
                    type: "GET",
                    // data:dateRequest,
