                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    <div id="dialog-form" title="Create new Account">
                                        ...
                                        <form action="{{url('/')}}" method="post">
                                            <fieldset>
                                                ...
                                                <textarea class="text ui-widget-content ui-corner-all" name="question"
                                                          id="question" style="width:300px"></textarea>
                                                <br/><br>
                                    ...
                                    <form method="POST" action="{{{ url('Appraisals') }}}">
                                        @csrf
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="appraisal_id" id="appraisal_id" class="form-control">
                                                    ...
                                                    @foreach($appraisals as $appraisal)
                                                        <option
                                                            value="{{ $appraisal->id }}"> {{ $appraisal->question }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                <label for="username">Performance Rating <span
                                            ...
                                            <div class="form-group">
                                                ...
                                                <table>
                                                    <tr>
                                                        <td width="120">
                                                            <input class="form-control maxsize" placeholder=""
                                                                   onkeypress="totalBalance()" onkeyup="totalBalance()"
                                                                   type="text" name="score" id="score"
                                                                   value="{{{ old('score') }}}">
                                                        </td>
                                                        <td width="60">
                                                            out of
                                                        ...
                                                        <td>
                                                            <input class="form-control" readonly placeholder=""
                                                                   type="text" name="maxscore" id="maxscore">
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" readonly placeholder="" type="text"
                                                       name="examiner" id="examiner" value="{{Auth::user()->username}}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="right-inner-addon ">
                                                    ...
                                                    <input class="form-control appdate" readonly="readonly"
                                                           placeholder="" type="text" name="date" id="date"
                                                           value="{{date('Y-m-d')}}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-actions form-group">
                                                ...
                                                <button type="submit" class="btn btn-primary btn-sm">Create Appraisal
                                                </button>
                                            </div>
